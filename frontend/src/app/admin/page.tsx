...
export default function AdminPage() {
  ...
  const statCards = [
    { label: 'Total Events', value: stats?.counts.events ?? 0, color: '#2563eb' },
    { label: 'Registrations', value: stats?.counts.registrations ?? 0, color: '#16a34a' },
    { label: 'Users', value: stats?.counts.users ?? 0, color: '#ea580c' },
    { label: 'Announcements', value: stats?.counts.announcements ?? 0, color: '#6b7280' },
  ];
